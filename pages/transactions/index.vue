...
export default {
  ...
  async mounted () {
    ...
    if (this.logged) {
      ...
      const resultRecipient = await axios(cosmosConfig[0].apiURL + '/cosmos/tx/v1beta1/txs?events=transfer.recipient=%27'+this.accounts[0].address+'%27&limit=10&order_by=2
')
