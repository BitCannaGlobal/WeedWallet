  ...
  methods: {
    ...
    async createProposalv1Beta() {
      ...
      const foundMsgType = defaultRegistryTypes.find(
        (element) => element[0] === "/cosmos.gov.v1beta1.MsgSubmitProposal"
      );
        ...
        finalMsg = {
          ...
          value: foundMsgType[1].fromPartial({
            content: Any.fromPartial({
              ...
              value: Uint8Array.from(
                CommunityPoolSpendProposal.encode(communityPoolSpend).finish()
              ),
            }),
            proposer: this.accounts[0].address,
            initialDeposit: initialDeposit,
        ...
        finalMsg = {
          ...
          value: foundMsgType[1].fromPartial({
            content: Any.fromPartial({
              ...
              value: Uint8Array.from(
                SoftwareUpgradeProposal.encode(softwareUpgrade).finish()
              ),
            }),
            proposer: this.accounts[0].address,
            initialDeposit: initialDeposit,
