          ...
          <v-container>
            ...
            <tbody>
              ...
              >
                ...
                <td> {{ (item.delegated / 1000000).toFixed(6) }} {{ cosmosConfig[chainId].coinLookup.viewDenom }}</td>
                <td> {{ item.reward }} {{ cosmosConfig[chainId].coinLookup.viewDenom }}</td>
              </tr>
            </tbody>          
            </v-simple-table>           
    ...
    methods: {
      ...
      async validate () {
        ...
        if  (this.$refs.form.validate() === true) {
          ...
          let gasEstimation = await client.simulate(accounts[0].address, finalMsg, this.memo)
      ...
      (async () => {
        ...
        try {          
          const result = await client.signAndBroadcast(accounts[0].address, copieDelegator, 'auto', '')
