...
module.exports = {
  async connectKeplrSuggest(dataChain) {
        ...
        try {
          ...
          await window.keplr.experimentalSuggestChain({
            ...
            bech32Config: {
              ...
              bech32PrefixValAddr:
                dataChain.coinLookup.addressPrefix + "valoper",
              bech32PrefixValPub:
                dataChain.coinLookup.addressPrefix + "valoperpub",
              bech32PrefixConsAddr:
                dataChain.coinLookup.addressPrefix + "valcons",
              bech32PrefixConsPub:
                dataChain.coinLookup.addressPrefix + "valconspub",
            },
    ...
    const getKey = await window.keplr.getKey(dataChain.chainId);
